  ...
  try {
    ...
    if (userExists) {
        ...
        const emailSent = await EmailService.sendCustomEmail(
          ...
          `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              ...
              <p><a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://talio.co.za'}/recruiter/dashboard" style="background-color: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;">Access Dashboard</a></p>
              <p>Best regards,<br>The Talio Team</p>
            </div>
          `,
          `Welcome to the team at ${recruiterInfo?.company_name || 'Your Company'}!\n\nHi ${full_name},\n\n${inviterProfile?.full_name || 'Team Admin'} has added you to the recruitment team at ${recruiterInfo?.company_name || 'Your Company'}.\n\nYour role: ${role}\n\nYou can now access the team dashboard and start collaborating with your team members.\n\nAccess Dashboard: ${process.env.NEXT_PUBLIC_SITE_URL || 'https://talio.co.za'}/recruiter/dashboard\n\nBest regards,\nThe Talio Team`
        )
      ...
      try {
        ...
        const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || process.env.NEXT_PUBLIC_APP_URL || 'https://talio.co.za'
