...
const tools = [
  ...
  },
  {
    ...
    icon: Brain,
    href: "/recruiter/tools/candidate-screening",
  ...
  },
  {
    ...
    icon: Wand2,
    href: "/recruiter/tools/jd-optimizer",
    color: "text-purple-500"
  },
  {
    ...
    icon: Search,
    href: "/recruiter/tools/resume-matching",
    color: "text-blue-500"
  },
  {
    ...
    icon: ListChecks,
    href: "/recruiter/tools/interview-questions",
  ...
  },
  {
    ...
    icon: Calendar,
    href: "/recruiter/tools/scheduler",
  ...
  },
  {
    ...
    icon: TrendingUp,
    href: "/recruiter/tools/salary-analyzer",
  ...
  },
  {
    ...
    icon: Target,
    href: "/recruiter/tools/skills-gap",
  ...
  },
  {
    ...
    icon: FileText,
    href: "/recruiter/tools/offer-letter",
    color: "text-indigo-500"
  },
  {
    ...
    icon: Users,
    href: "/recruiter/tools/candidate-experience",
    color: "text-pink-500",
    isNew: true
  },
  {
    ...
    icon: Shield,
    href: "/recruiter/tools/compliance",
    color: "text-red-500",
    isNew: true
  },
  {
    ...
    icon: Clock,
    href: "/recruiter/tools/time-to-hire",
    color: "text-cyan-500",
    isNew: true
  }
]
      ...
      <div className="px-12 py-20 max-w-7xl mx-auto">
        <div className="text-center mb-24">
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed tracking-wide mb-8">
            A comprehensive, intelligent toolbox designed to streamline your recruitment workflow 
            and enhance your hiring decisions with advanced automation and AI-powered insights.
          </p>
        ...
        <div className="mt-24 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Why Choose Our AI-Powered Tools?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="flex items-center justify-center w-16 h-16 bg-purple-100 rounded-full mb-6 mx-auto">
                <Brain className="w-8 h-8 text-purple-600" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Advanced AI Intelligence</h3>
              <p className="text-gray-600 leading-relaxed">
                Powered by cutting-edge AI models trained on South African market data for accurate, localized insights.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get instant insights with real-time data analysis and predictive analytics for better decision making.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Built with South African labor law compliance and enterprise-grade security for your peace of mind.
              </p>
            </div>
          </div>
        </div>
