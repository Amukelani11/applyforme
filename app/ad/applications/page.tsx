...
const mockApplications: Application[] = [
  ...
  {
    id: '3',
    candidate_name: 'Lisa Mokoena',
    candidate_email: 'lisa.mokoena@email.com',
    ai_score: 85,
    status: 'interview',
  ...
  },
  {
    ...
    candidate_email: 'david.smith@email.com',
    ai_score: 65,
    status: 'new',
  ...
  {
    id: '5',
    candidate_name: 'Amanda Patel',
    candidate_email: 'amanda.patel@email.com',
    ai_score: 88,
    status: 'shortlisted',
...
export default function AdApplicationsPage() {
  ...
  const jobId = 123; // Mock job ID

  const [applications, setApplications] = useState<Application[]>(mockApplications);
  const [jobData, setJobData] = useState<JobData | null>(mockJobData);
  ...
  const getNextUnreviewedApplication = () => {
    ...
    if (unreviewed) {
      router.push(`/ad/applications/${unreviewed.id}`);
    }
  };
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <button
                                  onClick={() => router.push(`/ad/applications/${application.id}`)}
