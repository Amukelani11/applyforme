...
import { Search, Filter, MoreHorizontal, Eye, Edit, Trash2, Shield, UserCheck, UserX, Key, Crown, Download } from 'lucide-react';
...
export default async function UsersPage() {
  ...
  const { users, error } = await getUsers(supabase);
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-900">
                            ...
                            {user.is_admin && <Crown className="inline ml-1 h-3 w-3 text-yellow-500" />}
                          </div>
